...
rOpt.insertRestaurantItem(restaurantName='rName2', password='12345',
                          phone='10293847568', email='rName2@mail.com')
rOpt.insertRestaurantItem(restaurantName='rName2', password='111111111111111111111',
                          phone='10293847568', email='rName2@mail.com')
rOpt.insertRestaurantItem(restaurantName='rName2', password='123456',
                          phone='10293847567', email='rName2@mail.com')
rOpt.insertRestaurantItem(restaurantName='rName2', password='123456',
                          phone='10293847568', email='rName1@mail.com')
rOpt.insertRestaurantItem(restaurantName='rName2', password='123456',
                          phone='10293847568', email='rName2@mail.com')
# select
print(selectOperator(tableName="Restaurants",
                     restaurantName='rName1', result=["restaurantID"]))
print(selectOperator(tableName="Restaurant",
                     restaurantName='rName1', result=["restaurantIDs"]))
print(selectOperator(tableName="Restaurant",
                     restaurantName='rName1', result=["restaurantID"]))
print(selectOperator(tableName="Restaurant", restaurantName='rName1',
                     phone='10293847567', result=["restaurantID", "email"]))
print(selectOperator(tableName="Restaurant",
                     restaurantName='rName3', result=["restaurantID"]))
print(selectOperator(tableName="Restaurant", restaurantName='rName3',
                     phone='10293847567', result=["restaurantID"]))
# update
updateOperator(rstName='null', pwd='123456', tableName='Restaurant',
               restaurantName='rName1', new_password='1234567')
updateOperator(rstName='rName1', pwd='123456', tableName='Restaurants',
               restaurantName='rName1', new_password='1234567')
updateOperator(rstName='rName1', pwd='1234567', tableName='Restaurant',
               restaurantName='rName1', new_phone='10293847569', new_restaurantName='rName2')
updateOperator(rstName='rName1', pwd='123456', tableName='Restaurant',
               restaurantName='rName1', new_password='1234567')
updateOperator(rstName='rName1', pwd='1234567', tableName='Restaurant',
...
dOpt.insertDishItem(dishName="dish1", dishDescription="This is dish1.",
                    price=1.0, dishImageURL="http://dish1.com", dishTypeID=5)
...
dOpt.insertDishItem(dishName="dish1", dishDescription="This is dish1.",
                    price=1.0, dishImageURL="http://dish1.com", dishTypeID=5)
dOpt.insertDishItem(dishName="dish1", dishDescription="This is dish1.",
                    price=1.0, dishImageURL="http://dish1.com", dishTypeID=7)
dOpt.insertDishItem(dishName="dish1", dishDescription="This is dish1.",
                    price=1.0, dishImageURL="http://dish1.com", dishTypeID=3)
dOpt.insertDishItem(dishName="dish2", dishDescription="This is dish2.",
                    price=1.0, dishImageURL="http://dish2.com", dishTypeID=5)
dOpt.insertDishItem(dishName="dish3", dishDescription="This is dish3.",
                    price=1.0, dishImageURL="http://dish3.com", dishTypeID=6)
dOpt.insertDishItem(dishName="dish4", dishDescription="This is dish4.",
                    price=1.0, dishImageURL="http://dish4.com", dishTypeID=6)
dOpt.insertDishItem(dishName="dish5", dishDescription="This is dish5.",
                    price=1.0, dishImageURL="http://dish5.com", dishTypeID=5)
dOpt.insertDishItem(dishName="dish6", dishDescription="This is dish6.",
                    price=1.0, dishImageURL="http://dish6.com", dishTypeID=5)
dOpt.manageDishTable(restaurantName='rName2', password='123456')
dOpt.insertDishItem(dishName="dish1", dishDescription="This is dish1.",
                    price=1.0, dishImageURL="http://dish1.com", dishTypeID=3)
dOpt.insertDishItem(dishName="dish2", dishDescription="This is dish2.",
                    price=1.0, dishImageURL="http://dish2.com", dishTypeID=3)
# delete
dOpt = dishOperator()
...
print("orderNumber:", oOpt.insertOrderItem(
    orderDetail=rDB, total=100.0, customerID="c1", tableID=5))
oOpt.manageOrderListTable(restaurantName='rName1', password='123456')
print("orderNumber:", oOpt.insertOrderItem(
    orderDetail="detail1", total=100.0, customerID="c5", tableID=7))
print("orderNumber:", oOpt.insertOrderItem(
    orderDetail=rDB, total=100.0, customerID="c1", tableID=5))
print("orderNumber:", oOpt.insertOrderItem(
    orderDetail="detail2", total=100.0, customerID="c2", tableID=5))
print("orderNumber:", oOpt.insertOrderItem(
    orderDetail="detail3", total=100.0, customerID="c3", tableID=5))
print("orderNumber:", oOpt.insertOrderItem(
    orderDetail="detail4", total=100.0, customerID="c4", tableID=5))
print("orderNumber:", oOpt.insertOrderItem(
    orderDetail="detail1", total=100.0, customerID="c5", tableID=6))
print("orderNumber:", oOpt.insertOrderItem(
    orderDetail="detail5", total=100.0, customerID="c6", tableID=5))
# delete
oOpt = orderListOperator()
...
rcOpt.insertRecommendationItem(
    title="spring", tag="123", imageURL="http://img1.jpg")
rcOpt.manageRecommendationTable(restaurantName='rName1', password='123456')
rcOpt.insertRecommendationItem(
    title="spring", tag="123", imageURL="http://img1.jpg")
rcOpt.insertRecommendationItem(
    title="summer", tag="456", imageURL="http://img2.jpg")
rcOpt.manageRecommendationTable(restaurantName='rName2', password='123456')
rcOpt.insertRecommendationItem(
    title="fall", tag="123", imageURL="http://img3.jpg")
rcOpt.insertRecommendationItem(
    title="winter", tag="456", imageURL="http://img4.jpg")
# delete
rcOpt = recommendationOperator()
...
rcdOpt.insertRecommendationDetailsItem(
    recommendationID=5, dishID=9, description="balabalabala...")
rcdOpt.insertRecommendationDetailsItem(
    recommendationID=2, dishID=11, description="balabalabala...")
rcdOpt.insertRecommendationDetailsItem(
    recommendationID=3, dishID=9, description="balabalabala...")
rcdOpt.insertRecommendationDetailsItem(
    recommendationID=2, dishID=9, description="balabalabala...")
rcdOpt.insertRecommendationDetailsItem(
    recommendationID=2, dishID=10, description="balabalabala...")
# delete
