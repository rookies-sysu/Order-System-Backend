...
class restaurantOperator():
    """ The operator for Table 'Restaurant'.
    Attributes:
        restaurantID: ID of restaurant
        hasSignedIn: whether manager has signed in with 'restaurantName' and 'password'
        restaurantName: name of restaurant
        password: password of restaurant
    """
    def __init__(self, restaurantName=None, password=None):
        """ Constructed function
        Initialize attributes of class and try to sign in.
        """
    ...
    def manageRestaurantTable(self, restaurantName, password):
        """ Get the right to manage Table 'Restaurant' with 'restaurantName' & 'password'
        Args:
            restaurantName: name of restaurant
            password: password of restaurant
        """
        if tools.signIn(restaurantName, password):
            ...
            self.restaurantID = selectUniqueItem(tableName="Restaurant", restaurantName=restaurantName, result=["restaurantID"])
    ...
    def insertRestaurantItem(self, restaurantName, password, phone, email):
        """ Insert restaurant item with parameters.
        Args:
            restaurantName: name of restaurant
            password: password of restaurant
            phone: phone
        ...
        Returns:
            Whether success to insert restaurant item.
            example:
                True / False
        """
        # check input info of restaurant item
    ...
    def checkRestaurantItem(self, restaurantName, password, phone, email):
        """ Check the correction of restaurant item with parameters.
        Args:
            restaurantName: name of restaurant
            password: password of restaurant
            phone: phone
        ...
        Returns:
            The correction of restaurant item.
            example:
                True / False
        """
    ...
    def deleteRestaurantByID(self, restaurantID):
        """ Delete Restaurant item with restaurantID.
        Args:
            restaurantID: the ID of restaurant

        Returns:
            Whether success to Delete Restaurant item.
            example:
                True / False
        """
        ...
        if self.hasSignedIn:
            if identifyOperator(tableName="Restaurant", restaurantID=restaurantID):
                ...
                restaurantName = selectUniqueItem(tableName="Restaurant", restaurantID=restaurantID, result=["restaurantName"])
    ...
    def deleteRestaurantByName(self, restaurantName):
        """ Delete Restaurant item with restaurantName.
        Args:
        ...
        Returns:
            ...
            example:
                True / False
        """
        # delete by restaurant name
        if self.hasSignedIn:
            if identifyOperator(tableName="Restaurant", restaurantName=restaurantName):
                restaurantID = selectUniqueItem(tableName="Restaurant", restaurantName=restaurantName, result=["restaurantID"])
                return self.deleteRestaurantByID(restaurantID)
            else:
    ...
    def deleteRestaurantForeignKey(self, restaurantID):
        """ Delete foreign key of Restaurant items with restaurantID.
        Args:
            restaurantID: the ID of restaurant

        Returns:
            Whether success to Delete Restaurant items.
            example:
                True / False
        """
        # DishType
...
class dishTypeOperator:
    """ The operator for Table 'DishType'.
    Attributes:
        restaurantID: ID of restaurant
        hasSignedIn: whether manager has signed in with 'restaurantName' and 'password'
        restaurantName: name of restaurant
    ...
    def manageDishTypeTable(self, restaurantName=None, password=None):
        """ Get the right to manage Table 'DishType' with 'restaurantName' & 'password'
        Args:
            restaurantName: name of restaurant
            password: password of restaurant
        """
    ...
    def insertDishTypeItem(self, dishTypeName):
        """ Insert dishType item with parameters.
        Args:
            dishTypeName: name of dishtype

        Returns:
            Whether success to insert dishType item.
            example:
                True / False
        """
        if self.hasSignedIn:
    ...
    def deleteDishTypeByID(self, dishTypeID):
        """ Delete DishType item with dishTypeID.
        Args:
            dishTypeID: the ID of dishType

        Returns:
            Whether success to Delete DishType item.
            example:
                True / False
        """
        if self.hasSignedIn:
            if identifyOperator(tableName="DishType", dishTypeID=dishTypeID):
                ...
                restaurantID = selectUniqueItem(tableName="DishType", dishTypeID=dishTypeID, result=["restaurantID"])
                if restaurantID != self.restaurantID:
                    print("[FAILED] No authority to Delete other's DishType items.")
                    return False
                # delete DishType by ID
                dishTypeName = selectUniqueItem(tableName="DishType", dishTypeID=dishTypeID, result=["dishTypeName"])
    ...
    def deleteDishTypeByName(self, dishTypeName):
        """ Delete DishType item with dishTypeName.
        Args:
            dishTypeName: the name of dishType
        ...
        if self.hasSignedIn:
            if identifyOperator(tableName="DishType", dishTypeName=dishTypeName):
                dishTypeID = selectUniqueItem(tableName="DishType", dishTypeName=dishTypeName, result=["dishTypeID"])
    ...
    def deleteDishTypeByRestaurantID(self, restaurantID):
        """ Delete DishType item with restaurantID.
        Args:
            restaurantID: the ID of restaurant
...
## -----------------------------------------------------
class tableOperator:
    """ The operator for Table 'RestaurantTable'.
    Attributes:
        restaurantID: ID of restaurant
        hasSignedIn: whether manager has signed in with 'restaurantName' and 'password'
        restaurantName: name of restaurant
    ...
    def manageTableTable(self, restaurantName=None, password=None):
        """ Get the right to manage Table 'RestaurantTable' with 'restaurantName' & 'password'
        Args:
            restaurantName: name of restaurant
            password: password of restaurant
        """
    ...
    def insertTableItem(self, tableNumber):
        """ Insert RestaurantTable item with parameters.
        Args:
            tableNumber: table number

        Returns:
            Whether success to insert RestaurantTable item.
            example:
                True / False
        """
        if self.hasSignedIn:
    ...
    def deleteTableByID(self, tableID):
        """ Delete RestaurantTable item with tableID.
        Args:
            tableID: the ID of table

        Returns:
            Whether success to Delete RestaurantTable item.
            example:
                True / False
        """
        if self.hasSignedIn:
    ...
    def deleteTableByNumber(self, tableNumber):
        """ Delete RestaurantTable item with tableNumber.
        Args:
            tableNumber: table number
    ...
    def deleteTableByRestaurantID(self, restaurantID):
        """ Delete RestaurantTable item with restaurantID.
        Args:
            restaurantID: the ID of restaurant
...
class QRlinkOperator:
    ...
    def manageQRlinkTable(self, restaurantName=None, password=None):
        """ Get the right to manage Table 'QRlink' with 'restaurantName' & 'password'
        Args:
            restaurantName: name of restaurant
            password: password of restaurant
        """
    ...
    def insertQRlinkItem(self, linkImageURL, tableNumber):
        """ Insert QRlink item with parameters.
        Args:
            linkImageURL: the URL of QRlink image
            tableNumber: table number

        Returns:
            Whether success to insert QRlink item.
            example:
                True / False
        """
        if self.hasSignedIn:
    ...
    def deleteLinkByID(self, linkID):
        """ Delete QRlink item with linkID.
        Args:
            linkID: the ID of QRlink

        Returns:
            Whether success to Delete QRlink item.
            example:
                True / False
        """
        if self.hasSignedIn:
    ...
    def deleteLinkByURL(self, linkImageURL):
        """ Delete QRlink item with linkImageURL.
        Args:
            linkImageURL: the URL of QRlink image
    ...
    def deleteLinkByTableID(self, tableID):
        """ Delete QRlink item with tableID.
        Args:
            tableID: the ID of table
...
class dishOperator:
    ...
    def manageDishTable(self, restaurantName=None, password=None):
        """ Get the right to manage Table 'Dish' with 'restaurantName' & 'password'
        Args:
            restaurantName: name of restaurant
            password: password of restaurant
        """
    ...
    def insertDishItem(self, dishName, dishDescription, price, dishImageURL, dishTypeID):
        """ Insert Dish item with parameters.
        Args:
            dishName: name of dish
            dishDescription: description of dish
            price: the price of dish
            dishImageURL: the image URL of dish
            dishTypeID: the ID of dishType

        Returns:
            Whether success to insert Dish item.
            example:
                True / False
        """
        if self.hasSignedIn:
    ...
    def deleteDishItemWithDishID(self, dishID):
        """ Delete Dish item with dishID.
        Args:
            dishID: the ID of dish

        Returns:
            Whether success to Delete Dish item.
            example:
                True / False
        """
        if self.hasSignedIn:
    ...
    def deleteDishItemsWithDishTypeID(self, dishTypeID):
        """ Delete Dish items with dishTypeID.
        Args:
            dishTypeID: the ID of dishType

        Returns:
            Whether success to Delete Dish items.
            example:
                True / False
        """
        if self.hasSignedIn:
    ...
    def deleteDishItemsWithRestaurantID(self, restaurantID):
        """ Delete Dish items with restaurantID.
        Args:
            restaurantID: the ID of Restaurant
...
class dishCommentOperator:
    """ The operator for Table 'DishComment'.
    Attributes:
        restaurantID: ID of restaurant
        hasSignedIn: whether manager has signed in with 'restaurantName' and 'password'
        restaurantName: name of restaurant
    ...
    def insertDishTypeItem(self, comment, dishID):
        ...
        Returns:
            Whether success to insert DishComment item.
            example:
                True / False
        """
        if identifyOperator(tableName="Dish", dishID=dishID):
    ...
    def deleteDishCommentByCommentID(self, dishCommentID):
        """ Delete DishComment items with dishCommentID.
        Args:
            dishCommentID: the ID of DishComment

        Returns:
            Whether success to Delete DishComment item.
            example:
                True / False
        """
    ...
    def deleteDishCommentsWithDishID(self, dishID):
        """ Delete DishComment items with dishID.
        Args:
            dishID: the ID of Dish
...
class orderListOperator:
    """ The operator for Table 'OrderList'.
    Attributes:
        restaurantID: ID of restaurant
        hasSignedIn: whether manager has signed in with 'restaurantName' and 'password'
        restaurantName: name of restaurant
    ...
    def manageOrderListTable(self, restaurantName=None, password=None):
        """ Get the right to manage Table 'OrderList' with 'restaurantName' & 'password'
        Args:
            restaurantName: name of restaurant
            password: password of restaurant
        """
    ...
    def insertOrderItem(self, orderDetail, total, customerID, tableID):
        """ Insert Order item with parameters.
        Args:
            orderDetail: detail of order
            total: the total price of order
            customerID: the ID of customer
            tableID: the ID of table

        Returns:
            Whether success to insert Order item.
            example:
                True / False
        """
        if self.hasSignedIn:
    ...
    def deleteOrderItemWithOrderID(self, orderID):
        """ Delete Order item with orderID.
        Args:
            orderID: the ID of Order

        Returns:
            Whether success to Delete Order item.
            example:
                True / False
        """
        if self.hasSignedIn:
    ...
    def deleteOrderItemsWithTableID(self, tableID):
        """ Delete Order item with tableID.
        Args:
            tableID: the ID of Table
    ...
    def getMaxNumber(self):
        """ Get the maximum number in the order table. """
...
class RecommendationOperator:
    """ The operator for Table 'Recommendation'.
    Attributes:
        restaurantID: ID of restaurant
        hasSignedIn: whether manager has signed in with 'restaurantName' and 'password'
        restaurantName: name of restaurant
    ...
    def manageRecommendationTable(self, restaurantName=None, password=None):
        """ Get the right to manage Table 'Recommendation' with 'restaurantName' & 'password'
        Args:
            restaurantName: name of restaurant
            password: password of restaurant
        """
    ...
    def insertRecommendationItem(self, title, tag, imageURL):
        """ Insert Recommendation item with parameters.
        Args:
            title: the title of recommendation
            tag: the tag of recommendation
            imageURL: the URL of image

        Returns:
            Whether success to insert Recommendation item.
            example:
                True / False
        """
        if self.hasSignedIn:
            # identify whether exist title in the restaurant
    ...
    def deleteRecommendationByID(self, recommendationID):
        """ Delete Recommendation item with recommendationID.
        Args:
            recommendationID: the ID of recommendation

        Returns:
            Whether success to Delete Recommendation item.
            example:
                True / False
        """
        if self.hasSignedIn:
...
class RecommendationDetailsOperator:
    """ The operator for Table 'RecommendationDetails'. """
    # Insert operator
    def insertRecommendationDetailsItem(self, recommendationID, dishID, description):
        """ Insert RecommendationDetails item with parameters.
        Args:
            recommendationID: the ID of recommendation
            dishID: the ID of dish
        ...
        Returns:
            Whether success to insert RecommendationDetails item.
            example:
                True / False
        """
        if identifyOperator(tableName="Recommendation", recommendationID=recommendationID):
    ...
    def deleteRecommendationDetailsByRecommendationID(self, recommendationID):
        """ Delete RecommendationDetails item with recommendationID.
        Args:
            recommendationID: the ID of recommendation

        Returns:
            Whether success to Delete RecommendationDetails item.
            example:
                True / False
        """
    ...
    def deleteRecommendationDetailsByDishID(self, dishID):
        """ Delete RecommendationDetails item with dishID.
        Args:
            dishID: the ID of Dish
...
def identifyOperator(tableName, **kwargs):
    ''' identify Operator with tableName, key-values for condition.
    Args:
        tableName: the name of the table
        **kwargs: key-value of table
    Returns:
        whether key-values can be found in database. 
    '''
    staus, result = selectOperator(tableName, **kwargs)
    return staus and len(result) != 0

def selectOperator(tableName, **kwargs):
    ''' Select Operator with tableName, key-values for condition and keys for selection.
    Args:
        tableName: the name of the table
        **kwargs: key-value of table
    Returns:
