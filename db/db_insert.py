...
# insert
dOpt.insertDishItem(dishName='dish1', price=1, dishImageURL='dish-img-URL-4-1', dishTypeID=1)
dOpt.insertDishItem(dishName='dish2', price=2, dishImageURL='dish-img-URL-4-2', dishTypeID=1)
dOpt.insertDishItem(dishName='dish3', price=3, dishImageURL='dish-img-URL-4-3', dishTypeID=2)
